...
import s from './MemberAffinityProfile.module.scss';
import {
  MOCK_MEMBER,
  MOCK_EXPERIENCE,
...
export default function MemberAffinityProfilePrototype() {
