...
import { deleteThread, getHuskyHistory } from '@/services/husky.service';
...
const IntroSidebarContainer = ({ isLoggedIn }: { isLoggedIn: boolean }) => {
      ...
      <Sidebar>
        <div data-state={state} className="sidebar__header">
          ...
          <button onClick={handleNewConversation} className="sidebar__header__newConversation">
            ...
            <span className="sidebar__header__newConversation__text">New Request</span>
          </button>
        </div>
          ...
          <div className="sidebar__body__history">
            <div onClick={handleOpenSidebar} className="sidebar__body__history__header">
              <div className="sidebar__body__history__header__title">
                ...
                <span className="sidebar__body__history__header__title__text">Requests</span>
              </div>
            </div>
            <div className="sidebar__body__history__list">
              {isLoading ? (
                ...
                <div className="sidebar__body__history__list__empty">Your requests will appear here once you start chatting!</div>
              ) : (
                <div>
                  </div>
...
export default IntroSidebarContainer;
