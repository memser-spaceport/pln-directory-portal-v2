...
export const currentRoundData: CurrentRoundData = {
  ...
  leaderboard: {
    ...
    cumulativeData: [
      ...
      { rank: 2, name: 'Anuj Pandey', activities: '', points: 8125 },
      { rank: 3, name: 'Molly Mackinlay', activities: '', points: 7600 },
      { rank: 4, name: 'David Casey', activities: '', points: 7000 },
      { rank: 5, name: 'Rich Chang', activities: '', points: 6250 },
      { rank: 6, name: 'Diana Stern', activities: '', points: 5950 },
      { rank: 7, name: 'Theresa Therriault', activities: '', points: 5650 },
      { rank: 8, name: 'Raymond Cheng', activities: '', points: 5450 },
      ...
      { rank: 12, name: 'William Scott', activities: '', points: 4200 },
      { rank: 13, name: 'Ian Brunner', activities: '', points: 4150 },
      { rank: 14, name: 'Cyril Delattre', activities: '', points: 3250 },
      { rank: 15, name: 'Derrick Lam', activities: '', points: 2750 },
      { rank: 16, name: 'Chris Brocoum', activities: '', points: 2750 },
      { rank: 17, name: 'Laura Brewer', activities: '', points: 2700 },
      { rank: 18, name: 'Victoria DeVesty', activities: '', points: 2500 },
      { rank: 19, name: 'Eshan Chordia', activities: '', points: 2400 },
      { rank: 20, name: 'Jeff De Gregorio', activities: '', points: 2150 },
      { rank: 21, name: 'Michael Stachiw', activities: '', points: 2100 },
      { rank: 22, name: 'Erick Watson', activities: '', points: 2000 },
      { rank: 23, name: 'Stefaan Vervaet', activities: '', points: 1900 },
      { rank: 24, name: 'Matthew Koch', activities: '', points: 1600 },
      { rank: 25, name: 'Lynnette Nolan', activities: '', points: 1450 },
      { rank: 26, name: 'Connor Dales', activities: '', points: 1300 },
      ...
      { rank: 30, name: 'Dottie Wang', activities: '', points: 900 },
      { rank: 31, name: 'Carl Cervone', activities: '', points: 900 },
      { rank: 32, name: 'Evan Miyazono', activities: '', points: 850 },
      { rank: 33, name: 'Ashley Franck', activities: '', points: 850 },
      { rank: 34, name: 'Zachary von Naumann', activities: '', points: 800 },
      ...
      { rank: 38, name: 'Rohit Goel', activities: '', points: 400 },
