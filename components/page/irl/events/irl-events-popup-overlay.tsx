...
const IrlEventsPopupOverlay = ({
  dialogRef,
  onCloseModal,
  resources,
  isLoggedIn,
  onLoginClickHandler,
  handleAdditionalResourceClick,
}: IrlEventsPopupOverlayProps) => {
          ...
          {!isLoggedIn && (
            <div className="root__irl__popup__header">
              ...
              <div>
                ...
                <span onClick={onLoginClickHandler} className="root__irl__popup__header__loginBtn">
                  login
                </span>{' '}
                to access
              </div>
