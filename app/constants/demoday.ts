export const faqItems = [
  {
    ...
    answer:
      'Protocol Labs Demo Day is a concentrated one-day virtual event featuring the most promising teams from across the Protocol Labs Network. Protocol Labs Demo Day takes place on October 23, 2025. A pre-selected and vetted batch of high-quality startups will deliver rapid-fire pitches. Investor attendees will have access to single-slide company summaries through an online platform. Following the event, attendees will have the opportunity to connect with the startups for follow-up Q&A.',
  },
  {
    question: 'Who can attend Demo Day?',
    answer:
