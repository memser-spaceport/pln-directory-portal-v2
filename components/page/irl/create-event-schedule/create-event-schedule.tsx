...
interface CreateEventScheduleProps {
  currentLocation: any;
}

const CreateEventSchedule = ({ currentLocation }: CreateEventScheduleProps) => {
  const analytics = useIrlAnalytics();
  const onCreateEventScheduleClicked = () => {
    analytics.trackIrlToCreateEventScheduleRedirectClicked(currentLocation);
  };
  return (
    <div className="root">
      <img 
        src="/icons/irl/Mobile.svg" 
        alt="Create Schedule Banner" 
        className="root__background-image"
      />
      <div className="root__schedule">
        ...
        <a href={process.env.EVENT_TOOLING_URL} target="_blank" rel="noopener noreferrer" className="root__schedule__btn" onClick={onCreateEventScheduleClicked}>
