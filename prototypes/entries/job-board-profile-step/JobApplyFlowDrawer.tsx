        ...
        hint: blockedByReview
          ...
          : !complete
            ...
            : /* FORK ONLY. This read "Experience, skills and bio are optional —
                 ...
                 above, in the same word — "Experience, projects and repositories
                 (Optional)" — so the footer was restating a visible control, and
                 restating it *wrongly*: it lists skills and bio, which live in
                 the header card and are not in the fold at all, so the two lines
                 made the same claim about different things.

                 What is left is the part neither the fold nor the button can
