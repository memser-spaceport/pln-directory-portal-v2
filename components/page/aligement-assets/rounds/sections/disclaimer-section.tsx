...
export default function DisclaimerSection({ children }: DisclaimerSectionProps) {
  const defaultContent = (
    <>
      ...
      any time as we learn and improve. The Alignment Asset Trust ultimately controls distributions, and we cannot
      guarantee the conversion of points to PLAA. This is for informational purposes only, and is not legal, financial,
      investment, or tax advice. Please read our{' '}
