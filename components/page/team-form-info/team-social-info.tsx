    ...
    <>
      <div className="teamSocialInfo__form">
        ...
        <div className="teamSocialInfo__form__item">
          <TextField isMandatory maxLength={200} id="register-team-contactMethod" label="Preferred method of contact*" name="contactMethod" type="text" placeholder="Enter contact method" />
          <p className="info">
        ...
        <div className="teamSocialInfo__form__item">
          <TextField isMandatory maxLength={1000} id="register-team-website" label="Website address*" name="website" type="text" placeholder="Enter address here" />
          <p className="info">
            <img src="/icons/info.svg" alt="name info" width="16" height="16px" />{' '}
        ...
        <TextField id="register-team-linkedinHandler" maxLength={200} label="LinkedIn" name="linkedinHandler" type="text" placeholder="eg., https://www.linkedin.com/in/jbenetcs/" />
        <TextField id="register-team-twitterHandler" maxLength={200} label="Twitter" name="twitterHandler" type="text" placeholder="e.g., @protocollabs" />
        <TextField id="register-team-telegramHandler" maxLength={200} label="Telegram" name="telegramHandler" type="text" placeholder="Telegram" />
        <div className="teamSocialInfo__form__item">
          <TextField id="register-team-blog" maxLength={1000} label="Blog address" name="blog" type="text" placeholder="Enter address here" />
          <p className="info">
            <img src="/icons/info.svg" alt="name info" width="16" height="16px" />{' '}
