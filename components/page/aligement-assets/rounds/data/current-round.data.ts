...
export const currentRoundData: CurrentRoundData = {
  ...
  leaderboard: {
    currentSnapshotData: [
      ...
      { rank: 6, name: 'Camille Bagnall', activities: '', points: 0 },
      { rank: 7, name: 'Carl Cervone', activities: '', points: 0 },
      { rank: 8, name: 'Chris Brocoum', activities: '', points: 0 },
      { rank: 9, name: 'Connor Dales', activities: '', points: 0 },
      { rank: 10, name: 'Corey James', activities: '', points: 0 },
      { rank: 11, name: 'Cyril Delattre', activities: '', points: 0 },
      { rank: 12, name: 'David Casey', activities: '', points: 0 },
      { rank: 13, name: 'David Huseby', activities: '', points: 0 },
      { rank: 14, name: 'Derrick Lam', activities: '', points: 0 },
      { rank: 15, name: 'Diana Stern', activities: '', points: 0 },
      { rank: 16, name: 'Dottie Wang', activities: '', points: 0 },
      { rank: 17, name: 'Erick Watson', activities: '', points: 0 },
      { rank: 18, name: 'Eshan Chordia', activities: '', points: 0 },
      { rank: 19, name: 'Evan Miyazono', activities: '', points: 0 },
      { rank: 20, name: 'Francesca Cohen', activities: '', points: 0 },
      { rank: 21, name: 'Ian Brunner', activities: '', points: 0 },
      { rank: 22, name: 'Jeff De Gregorio', activities: '', points: 0 },
      { rank: 23, name: 'Jennifer Denini', activities: '', points: 0 },
      { rank: 24, name: 'Jonathan Victor', activities: '', points: 0 },
      { rank: 25, name: 'Juan Benet', activities: '', points: 0 },
      { rank: 26, name: 'Julio Garcia', activities: '', points: 0 },
      { rank: 27, name: 'Justin Melillo', activities: '', points: 0 },
      { rank: 28, name: 'Karla Tang', activities: '', points: 0 },
      { rank: 29, name: 'Kevin Houng', activities: '', points: 0 },
      { rank: 30, name: 'Laura Brewer', activities: '', points: 0 },
      { rank: 31, name: 'Lynnette Nolan', activities: '', points: 0 },
      { rank: 32, name: 'Matthew Koch', activities: '', points: 0 },
      { rank: 33, name: 'Michael Stachiw', activities: '', points: 0 },
