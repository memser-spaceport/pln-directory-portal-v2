      ...
      <div className="irlheaderCnt">
        ...
        {true && (
          <div className="irlsubHeader">
            <div className="irlsubHeader__text">Organize your events in just a few clicks, start here.</div>
            <div className="irlsubHeader__actions">
              <div className="desktopActions">
                <Link href={`${process.env.IRL_SUBMIT_FORM_URL}/add`} legacyBehavior target="_blank">
                  <a target="_blank" className="root__submit">
              ...
              <div className="mobileActions">
                <button className="mobileActionButton" onClick={toggleDropdown}>
                  <img src="/icons/actions.svg" height={20} width={20} alt="actions" />
                  <span>Actions</span>
                </button>
