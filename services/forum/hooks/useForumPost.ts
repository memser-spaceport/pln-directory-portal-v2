...
export type TopicResponse = {
  ...
  posts: {
    ...
    upvoted: boolean;
    upvotes: number;
    user: { uid: 1; username: 'welcome'; userslug: 'welcome'; reputation: 0; postcount: 13; displayname: string; teamName: string | null; teamRole: string | null; picture: string; memberUid: string };
    votes: 0;
    parent: {
      content: string;
      pid: number;
