...
export const currentRoundData: CurrentRoundData = {
  ...
  leaderboard: {
    currentSnapshotData: [
      { rank: 1, name: 'Ian Brunner', activities: '', points: 300 },
      ...
      { rank: 16, name: 'David Dao', activities: '', points: 0 },
      { rank: 17, name: 'David Huseby', activities: '', points: 0 },
      { rank: 18, name: 'Derrick Lam', activities: '', points: 0 },
      { rank: 19, name: 'Diana Stern', activities: '', points: 0 },
      { rank: 20, name: 'Diego Leal Togni', activities: '', points: 0 },
      { rank: 21, name: 'Dottie Wang', activities: '', points: 0 },
      { rank: 22, name: 'Erick Watson', activities: '', points: 0 },
      { rank: 23, name: 'Eshan Chordia', activities: '', points: 0 },
      { rank: 24, name: 'Evan Miyazono', activities: '', points: 0 },
      { rank: 25, name: 'Francesca Cohen', activities: '', points: 0 },
      { rank: 26, name: 'Holke Brammer', activities: '', points: 0 },
      { rank: 27, name: 'Jeff De Gregorio', activities: '', points: 0 },
      { rank: 28, name: 'Jennifer Denini', activities: '', points: 0 },
      { rank: 29, name: 'Jeremy Kloth', activities: '', points: 0 },
      ...
      { rank: 40, name: 'Michael Stachiw', activities: '', points: 0 },
