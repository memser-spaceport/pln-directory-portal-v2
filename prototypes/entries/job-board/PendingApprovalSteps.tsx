...
/* No props. Every step is fixed: nothing here depends on what the member has
   done, because until approval there is nothing they can do. */

export function PendingApprovalSteps() {
  ...
  const steps = [
    {
      ...
      description: 'Our team will review your account shortly.',
