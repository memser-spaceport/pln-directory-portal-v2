...
export const currentRoundData: CurrentRoundData = {
  ...
  leaderboard: {
    currentSnapshotData: [
      ...
      { rank: 21, name: 'Anuj Pandey', activities: '', points: 0 },
      { rank: 22, name: 'Arleen Teranishi', activities: '', points: 0 },
      { rank: 23, name: 'Ashley Franck', activities: '', points: 0 },
      ...
      { rank: 28, name: 'David Huseby', activities: '', points: 0 },
      { rank: 29, name: 'Derrick Lam', activities: '', points: 0 },
      { rank: 30, name: 'Diana Stern', activities: '', points: 0 },
      { rank: 31, name: 'Erick Watson', activities: '', points: 0 },
      { rank: 32, name: 'Evan Miyazono', activities: '', points: 0 },
      { rank: 33, name: 'Francesca Cohen', activities: '', points: 0 },
      { rank: 34, name: 'Jennifer Denini', activities: '', points: 0 },
      { rank: 35, name: 'Jonathan Victor', activities: '', points: 0 },
      { rank: 36, name: 'Julio Garcia', activities: '', points: 0 },
      ...
      { rank: 43, name: 'Raymond Cheng', activities: '', points: 0 },
      { rank: 44, name: 'René Pinnell', activities: '', points: 0 },
