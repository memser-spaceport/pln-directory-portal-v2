...
export const VideoPitchView = ({ team, isLoggedIn, userInfo, isEditable, showIncomplete, onEdit }: Props) => {
    ...
    <>
      {showIncomplete && (
        <div className={s.incompleteStrip}>
          ...
          To participate in Demo Day, you must upload Video Pitch. Profiles without these will not be shown to investors.
        </div>
      )}
          ...
          <div className={s.section}>
            <div className={s.col}>
              <p className={s.description}>
                Record a short pitch video (up to 5 minutes). This will be available to investors on Demo Day alongside your one-pager. Keep it engaging — cover your team, problem, solution, traction,
                and fundraising ask.
              </p>
              <FileUploader
