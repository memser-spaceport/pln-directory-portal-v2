...
>(({ className, onSubmit, isAnswerLoading, isLoadingObject, onStopStreaming, isLimitReached, onTextSubmit, ...props }, ref) => {
  
  return (
    <>
      <div className={`chat__box ${className || ''}`}>
        <div className="chat__box__search-icon">🧠</div>
        <textarea {...props} ref={ref} className="chat__box__search-input" />
        {!isMobileDevice() && (
        ...
        <div className="huskyinput__action">
          {isAnswerLoading ? (
            ...
            } title="Stop" className="huskyinput__action__submit huskyinput__action__submit--loading">
            ...
            } title="Submit query" className="huskyinput__action__submit">
              <img className="huskyinput__action__submit__btn" src="/icons/send.svg" alt="Send" />
            </button>
          )}
        </div>
