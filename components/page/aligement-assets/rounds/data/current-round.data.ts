...
export const currentRoundData: CurrentRoundData = {
  ...
  leaderboard: {
    currentSnapshotData: [
      { rank: 1, name: 'Corey James', activities: '', points: 150 },
      { rank: 2, name: 'Michael Stachiw', activities: '', points: 150 },
      { rank: 3, name: 'Camille Bagnall', activities: '', points: 100 },
      { rank: 4, name: 'Jennifer Denini', activities: '', points: 100 },
      { rank: 5, name: 'Alex Feerst', activities: '', points: 0 },
      { rank: 6, name: 'Anuj Pandey', activities: '', points: 0 },
      { rank: 7, name: 'Arleen Teranishi', activities: '', points: 0 },
      { rank: 8, name: 'Ashley Franck', activities: '', points: 0 },
      { rank: 9, name: 'Bradley Holden', activities: '', points: 0 },
      ...
      { rank: 14, name: 'David Casey', activities: '', points: 0 },
      ...
      { rank: 23, name: 'Ian Brunner', activities: '', points: 0 },
      { rank: 24, name: 'Jeff De Gregorio', activities: '', points: 0 },
      { rank: 25, name: 'Jonathan Victor', activities: '', points: 0 },
      { rank: 26, name: 'Juan Benet', activities: '', points: 0 },
      { rank: 27, name: 'Julio Garcia', activities: '', points: 0 },
      { rank: 28, name: 'Justin Melillo', activities: '', points: 0 },
      { rank: 29, name: 'Karla Tang', activities: '', points: 0 },
      { rank: 30, name: 'Kevin Houng', activities: '', points: 0 },
      { rank: 31, name: 'Laura Brewer', activities: '', points: 0 },
      { rank: 32, name: 'Lynnette Nolan', activities: '', points: 0 },
      { rank: 33, name: 'Matthew Koch', activities: '', points: 0 },
      { rank: 34, name: 'Michelle Lee', activities: '', points: 0 },
      { rank: 35, name: 'Molly Mackinlay', activities: '', points: 0 },
      { rank: 36, name: 'Monica Ortel', activities: '', points: 0 },
      { rank: 37, name: 'Patrick Kim', activities: '', points: 0 },
      { rank: 38, name: 'Raymond Cheng', activities: '', points: 0 },
      { rank: 39, name: 'René Pinnell', activities: '', points: 0 },
      { rank: 40, name: 'Rich Chang', activities: '', points: 0 },
      { rank: 41, name: 'Rohit Goel', activities: '', points: 0 },
      { rank: 42, name: 'Russell Dempsey', activities: '', points: 0 },
      { rank: 43, name: 'Shae Biron', activities: '', points: 0 },
      { rank: 44, name: 'Stefaan Vervaet', activities: '', points: 0 },
      { rank: 45, name: 'Stefanie Wykoff', activities: '', points: 0 },
