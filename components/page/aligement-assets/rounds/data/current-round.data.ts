...
export const currentRoundData: CurrentRoundData = {
  ...
  leaderboard: {
    currentSnapshotData: [
      ...
      { rank: 23, name: 'Dottie Wang', activities: '', points: 0 },
      { rank: 24, name: 'Erick Watson', activities: '', points: 0 },
      { rank: 25, name: 'Eshan Chordia', activities: '', points: 0 },
      { rank: 26, name: 'Evan Miyazono', activities: '', points: 0 },
      { rank: 27, name: 'Francesca Cohen', activities: '', points: 0 },
      ...
      { rank: 42, name: 'Rich Chang', activities: '', points: 0 },
    ...
    cumulativeData: [
      ...
      { rank: 43, name: 'Sabeen Ali', activities: '', points: 0 },
    ]
  },
