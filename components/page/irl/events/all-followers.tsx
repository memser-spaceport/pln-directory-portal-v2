        ...
        <div className="cm">
          ...
          <div className="cm__body__followers">
            {filteredFollowers?.map((follower: any, index: number) => {
              return (
                <div key={'follower' + follower?.uid}
                  className={`follower__wrpr ${index !== filteredFollowers.length - 1 ? "borderb" : ""}`}
                >
                  <a href={`${process.env.APPLICATION_BASE_URL}/members/${follower.memberUid}`}
                    target='_blank'
                    ...
                    <div className="follower">
                      <div className="follower__info">
                        <div className="follower__info__imgWrpr">
                          <Image alt="profile" width={40} height={40} layout='intrinsic' loading='eager' priority={true} className="follower__info__img" src={follower.logo || '/icons/default_profile.svg'} />
                          {follower?.teamLead &&
                            <>
                              <Tooltip asChild trigger={<img src="/icons/badge/team-lead.svg" className="follower__info__teamlead" alt="team lead image" width={16} height={16} />}
                                content="Team Lead" />
                            </>}
                        </div>
