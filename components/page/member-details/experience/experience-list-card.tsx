            ...
            <div className={styles?.memberDetail__experience__header__actions}>
              ...
              {experiences.length > 3 && (
                <PopupTriggerIconButton
                  label="See All"
                  size={16}
                  triggerEvent={EVENTS.TRIGGER_SEE_ALL_EXPERIENCE_MODAL}
                  data={seeAllExperienceData}
                  alt="seeall"
                  analyticsData={{ method: 'onSeeAllExperienceClicked', user: userInfo, member: member }}
                />
              )}
            </div>
          </div>
