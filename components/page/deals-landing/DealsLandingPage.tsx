              ...
              <div className={s.exampleDealsGrid}>
                {mockValueProps.map((prop, i) => (
                  <div key={i} className={s.exampleDealCard}>
                    <span className={s.valuePropIcon} aria-hidden="true">
                      <ValuePropSvg name={prop.icon} />
                    </span>
          ...
          <section className={s.section}>
            <div className={s.sectionInner}>
              <div className={s.faqWrapper}>
                <FAQ title="Frequently Asked Questions" subtitle={null} items={mockFaqItems} />
              </div>
            </div>
          </section>
