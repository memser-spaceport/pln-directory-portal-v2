...
const disclosureContent = [
  ...
  'The Trust seeks to track the overall performance and development of the Protocol Labs Network through investments and other activities associated with the Protocol Labs Network and administered by the Trustee. To facilitate participation in the program, the Trust will issue rights to eligible participants that permit participation in auction events and certain other program activities (the "Rights"). However, the Rights do not represent an ownership interest in the Trust, the Protocol Labs Network, or any network participant, and do not entitle holders to participate directly in the revenues, profits, assets, net asset value or appreciation of the Protocol Labs Network or the Trust. The Rights also do not confer any voting, governance or similar rights with respect to the Trust, the Protocol Labs Network or any network participant. Rather, the Rights provide holders with the ability to participate in auction events and certain other program activities in accordance with the terms of the Trust Documents.',
  'Rights that are accepted in an auction event will be settled through the issuance of Alignment Asset Tokens as part of the Trust\'s settlement process. The Alignment Asset Tokens are used solely in connection with settlement and are not intended to be held by participants on an ongoing basis. In connection with a settlement event, Alignment Asset Tokens will be issued and then immediately purchased by the Trust in exchange for cash or other consideration in accordance with the terms of the Trust Documents. The Rights and settled Alignment Asset Tokens are experimental in nature, and recipients should understand that their design, implementation, and utility may change materially over time.',
  'PL-Init and Polaris are involved in aspects of the program that may affect the Rights, the Alignment Asset Tokens and the PLAA1 Trust. For example, PL-Init may participate in governance decisions affecting the Protocol Labs Network and is the primary contributor of assets to the PLAA1 Trust. Meanwhile, Polaris measures network activities that are used by the Trust in determining allocations of Rights to participants. In addition, personnel of PL-Init and Polaris may receive Rights and therefore may have interests that differ from those of other participants in the Protocol Labs Network. As a result, conflicts of interest may arise. In particular, (i) PL-Init\'s participation in governance decisions may influence outcomes in ways that benefit PL-Init or personnel at the expense of recipients of Rights or other participants in the Protocol Labs Network; (ii) Polaris\'s role in measuring network activities used to determine Token allocations of Rights may create a conflict, as Polaris\'s measurement methodology may affect allocations to its own personnel and affiliates; and (iii) PL-Init, Polaris and their personnel are direct economic beneficiaries of the Tokens and may otherwise pursue objectives or take positions that advance their own interests, which may not always align with the interests of recipients of Rights or other participants in the Protocol Labs Network. Recipients should carefully consider these conflicts when evaluating any information provided by PL-Init or Polaris.',
  'PL-Init and Polaris are not acting as investment advisers, financial advisers, sponsors, brokers, solicitors, underwriters, or fiduciaries with respect to the PLAA1 Trust, the Rights, or any Alignment Asset Tokens. When PL-Init and Polaris communicate or share materials relating to the PLAA1 Trust, the Rights, or any Alignment Asset Tokens ("AA Comms"), they do not take into account any recipient\'s particular financial, legal, tax, or investment circumstances, objectives or restrictions. AA Comms are provided for informational purposes only and should not be construed as investment, legal, tax, or financial advice or as a recommendation to hold, transfer, or dispose of any Rights or Alignment Asset Tokens. Any views or opinions expressed in AA Comms are general in nature and are not directed to any particular recipient. Recipients are solely responsible for evaluating the merits and risks associated with the Rights and any Alignment Asset Tokens and for making their own independent decisions with respect thereto.',
    ...
    <>
      <div className="disclosure">
        <div className="disclosure__title">
          ...
          <div className="disclosure__date">Last Updated: June 3, 2026</div>
        </div>
