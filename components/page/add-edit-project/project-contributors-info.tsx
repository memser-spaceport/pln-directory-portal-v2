...
export default function ProjectContributorsInfo(props: IProjectContributorsInfo) {
  ...
  const [selectedMaintainingTeam, setSelectedMaintainingTeam] = useState<any>(
    project?.maintainingTeam ?? project.maintainingTeam,
  );
  const [selectedContributingTeams, setSelectedContributingTeams] = useState(
    project.contributingTeams ? project.contributingTeams : [],
  );
      ...
      <div className="projectContributorsc">
        ...
        <div className="projectContributorsc__teams">
          <div className="projectContributorsc__teams__titlesec">
            ...
            {(selectedContributingTeams.length > 0 || selectedMaintainingTeam) && (
          ...
          <div className="projectContributorsc__teams__selectedTeams">
            ...
            {selectedMaintainingTeam && (
              <div
                className={`projectContributorsc__teams__selectedTeams__team ${selectedContributingTeams.length > 0 ? 'border-bottom' : ''}`}
              >
                <div className="projectContributorsc__teams__selectedTeams__teamc">
                  <div className="projectContributorsc__teams__selectedTeams__teamc__namec">
                    <img
                      ...
                      width={20}
                      src={
                        selectedMaintainingTeam?.logo ? selectedMaintainingTeam.logo : '/icons/team-default-profile.svg'
                      }
                    />

                    <div className="projectContributorsc__teams__selectedTeams__teamc__namec__name">
                      {selectedMaintainingTeam.name}
                    </div>
                  </div>
                  <div className="projectContributorsc__teams__selectedTeams__teamc__opts">
                    <div className="projectContributorsc__teams__selectedTeams__teamc__opts__badge">
                      ...
                      <div className="projectContributorsc__teams__selectedTeams__teamc__opts__badge__name">
                        Maintainer Team
                      </div>
                    </div>
                    ...
                    <button
                      type="button"
                      onClick={() => onOpenPopup('MaintainingTeam')}
                      className="projectContributorsc__teams__selectedTeams__teamc__opts__change"
                    >
            ...
            {selectedContributingTeams?.map((team: any, index: number) => (
              <div
                key={`${team}+${index}`}
                className={`projectContributorsc__teams__selectedTeams__team ${index < selectedContributingTeams.length - 1 ? 'border-bottom' : ''}`}
              >
                <div className="projectContributorsc__teams__selectedTeams__teamc">
                  <div className="projectContributorsc__teams__selectedTeams__teamc__namec">
                    <img
                ...
                <HiddenField
                  ...
                  name={`contributingTeams${index}-name`}
                />
          ...
          <div className="projectContributorsc__teams__descSec">
            <img
              ...
              width="16"
              height="16px"
              className="projectContributorsc__teams__descSec__nte"
            />
            <span className="projectContributorsc__teams__descSec__desc">
              Adding a maintainer team is required, and only one team can serve as the maintainer.{' '}
            </span>
          </div>
        </div>
        ...
        <div className="projectContributorsc__contributors">
          <div className="projectContributorsc__contributors__titlesec">
            <div className="projectContributorsc__contributors__titlesec__title">
              CONTRIBUTORS ({selectedContributors?.length})
            </div>
            {selectedContributors?.length > 0 && (
              <button
                type="button"
                className="projectContributorsc__contributors__titlesec__addBtn"
                onClick={onAddRemoveContributorClickHandler}
              >
                Add/Remove
              </button>
            )}
          ...
          {selectedContributors.length === 0 && (
            <div className="projectContributorsc__contributors__empty">
              ...
              <button
                type="button"
                onClick={onAddRemoveContributorClickHandler}
                className="projectContributorsc__contributors__empty__opt"
              >
            ...
            <>
              <div className="projectContributorsc__contributors__sContributors">
                {selectedContributors?.map((contributor: any, index: any) => {
                  ...
                  return (
                    <div
                      onClick={() => onContributorClicked(contributor)}
                      className="projectContributorsc__contributors__sContributors__cptr"
                      key={`${contributor} + ${index}`}
                    >
                      <img
                        className="projectContributorsc__contributors__sContributors__profile"
                        height={32}
                        width={32}
                      ...
                      <HiddenField
                        ...
                        defaultValue={contributor?.uid}
                        name={`contributions${index}-memberUid`}
                      />
                      <HiddenField
                        value={contributor?.cuid}
                        defaultValue={contributor?.cuid}
                        name={`contributions${index}-uid`}
                      />
                    </div>
                  );
                })}
          ...
          <div className="projectContributorsc__contrs__descSec">
            <img
              ...
              width="16"
              height="16px"
              className="projectContributorsc__contrs__descSec__nte"
            />
            <span className="projectContributorsc__contrs__descSec__desc">
              Contributors are individuals who have made past contributions or are currently actively contributing to a
