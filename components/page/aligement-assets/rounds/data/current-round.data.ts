...
export const currentRoundData: CurrentRoundData = {
  ...
  leaderboard: {
    currentSnapshotData: [
      { rank: 1, name: 'Molly Mackinlay', activities: '', points: 750 },
      { rank: 2, name: 'Ian Brunner', activities: '', points: 300 },
      { rank: 3, name: 'Theresa Therriault', activities: '', points: 300 },
      { rank: 4, name: 'Connor Dales', activities: '', points: 100 },
      { rank: 5, name: 'Dottie Wang', activities: '', points: 100 },
      ...
      { rank: 11, name: 'Cameron Wood', activities: '', points: 0 },
      { rank: 12, name: 'Camille Bagnall', activities: '', points: 0 },
      { rank: 13, name: 'Carl Cervone', activities: '', points: 0 },
      { rank: 14, name: 'Chris Brocoum', activities: '', points: 0 },
      { rank: 15, name: 'Corey James', activities: '', points: 0 },
      { rank: 16, name: 'Cyril Delattre', activities: '', points: 0 },
      { rank: 17, name: 'David Casey', activities: '', points: 0 },
      { rank: 18, name: 'David Dao', activities: '', points: 0 },
      { rank: 19, name: 'David Huseby', activities: '', points: 0 },
      { rank: 20, name: 'Derrick Lam', activities: '', points: 0 },
      { rank: 21, name: 'Diana Stern', activities: '', points: 0 },
      { rank: 22, name: 'Diego Leal Togni', activities: '', points: 0 },
      { rank: 23, name: 'Erick Watson', activities: '', points: 0 },
      { rank: 24, name: 'Eshan Chordia', activities: '', points: 0 },
      { rank: 25, name: 'Evan Miyazono', activities: '', points: 0 },
      { rank: 26, name: 'Francesca Cohen', activities: '', points: 0 },
      { rank: 27, name: 'Holke Brammer', activities: '', points: 0 },
      { rank: 28, name: 'Jeff De Gregorio', activities: '', points: 0 },
      { rank: 29, name: 'Jennifer Denini', activities: '', points: 0 },
      { rank: 30, name: 'Jeremy Kloth', activities: '', points: 0 },
      { rank: 31, name: 'Jonathan Victor', activities: '', points: 0 },
      { rank: 32, name: 'Juan Benet', activities: '', points: 0 },
      { rank: 33, name: 'Julian Gruber', activities: '', points: 0 },
      { rank: 34, name: 'Julio Garcia', activities: '', points: 0 },
      { rank: 35, name: 'Justin Melillo', activities: '', points: 0 },
      { rank: 36, name: 'Karla Tang', activities: '', points: 0 },
      { rank: 37, name: 'Kevin Houng', activities: '', points: 0 },
      { rank: 38, name: 'Laura Brewer', activities: '', points: 0 },
      { rank: 39, name: 'Lynnette Nolan', activities: '', points: 0 },
