...
import { DISCLOSURE_URL, STSP_SUPPORT_EMAIL } from '@/constants/plaa';
    ...
    items: [
      {
        ...
        answer: (
          <p>
            The Simultaneous Token Settlement Program (STSP) is a new program developed by PLAA Trust to facilitate the
            ...
            to cash (or other consideration).
          </p>
        ),
      },
      {
      ...
      },
      {
        ...
        answer:
          'PLCS employees have additional withholding mechanics. The following applies even if you provide services via a PLCS employer. For PL Infra members who are employees of PLCS, applicable tax withholding may apply at the time of settlement.',
      },
      {
        ...
        answer: (
          <div>
            <p style={{ marginBottom: '12px' }}>
              ...
              which can be found in your end of year transaction report from the PLAA Trust Company. If you have
      ...
      },
      {
        ...
        answer: (
          <p>
            ...
            Tokens not issued before October 1, 2025 will automatically be issued as Sigma instead.
          </p>
        ),
      },
      {
        ...
        answer: (
          <p>
            Please contact{' '}
            <a href={`mailto:${STSP_SUPPORT_EMAIL}`} style={{ color: '#156ff7', textDecoration: 'underline' }}>
              {STSP_SUPPORT_EMAIL}
            </a>
            ...
            expected, potentially up to one to two weeks. To ensure transparency, we will aim to publish answers to
