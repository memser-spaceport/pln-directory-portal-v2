...
const IrlSeeMoreLocationCard = (props: IrlSeeMoreLocationCardProps) => {
  ...
  return (
    <>
      <div ref={locationRef} className="root__irl__expanded" onClick={(e: any) => handleClick(e)}>
        <div className="root__irl__expanded__showMore">See Other Locations</div>
        <div className="root_irl__expanded__imgcntr">
          {locations
            ?.slice(count, locationsToSlice)
            .map((location: { flag: any }, index: React.Key | null | undefined) => (
