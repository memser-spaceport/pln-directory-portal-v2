...
export const currentRoundData: CurrentRoundData = {
  ...
  leaderboard: {
    currentSnapshotData: [
      { rank: 1, name: 'Jeremy Kloth', activities: '', points: 300 },
      { rank: 2, name: 'Anuj Pandey', activities: '', points: 150 },
      { rank: 3, name: 'Bradley Holden', activities: '', points: 150 },
      { rank: 4, name: 'Juan Benet', activities: '', points: 150 },
      { rank: 5, name: 'Lynnette Nolan', activities: '', points: 150 },
      { rank: 6, name: 'Molly Mackinlay', activities: '', points: 150 },
      { rank: 7, name: 'Theresa Therriault', activities: '', points: 150 },
      { rank: 8, name: 'Alex Feerst', activities: '', points: 0 },
      { rank: 9, name: 'Arleen Teranishi', activities: '', points: 0 },
      { rank: 10, name: 'Ashley Franck', activities: '', points: 0 },
      ...
      { rank: 15, name: 'Connor Dales', activities: '', points: 0 },
      { rank: 16, name: 'Corey James', activities: '', points: 0 },
      { rank: 17, name: 'Cyril Delattre', activities: '', points: 0 },
      { rank: 18, name: 'David Casey', activities: '', points: 0 },
      { rank: 19, name: 'David Doe', activities: '', points: 0 },
      ...
      { rank: 45, name: 'Patrick McCliug', activities: '', points: 0 },
