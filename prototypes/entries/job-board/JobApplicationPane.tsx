...
// The profile half of the application, quoted — shared with the interest route.
      ...
      <FormProvider {...methods}>
        ...
        <div className={s.body}>
          {/* The read-back: not a summary of the application, the application's
              first half, quoted. Shared with the interest route, which sends the
              same profile — see `ProfileReadback`. */}
          <ProfileReadback
            profile={profile}
