...
/**
 * SignUpInputs component renders the sign-up form with various input fields
 * including profile image upload, name, email, team/project selection, and skills selection.
 * It also includes consent checkboxes for data collection policy and newsletter subscription.
 *
 * @param {Object} props - The component props.
 * @param {Array} props.skillsInfo - The list of available skills options.
 * @param {Object} props.errors - The object containing validation errors for the form fields.
 *
