...
/**
 * Warning icon for access denied variant
 */
 ...
 */
export function VerifyEmailModal({ content, handleModalClose, dialogRef }: VerifyEmailModalProps) {
