...
// The forum LikesButton thumbs-up (components/page/forum/LikesButton), copied
// verbatim per the newsfeed-v0 prototype so a like in the news feed reads
// exactly like a like in the forum.
function LikeIcon() {
  return (
