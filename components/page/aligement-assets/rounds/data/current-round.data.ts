...
export const currentRoundData: CurrentRoundData = {
  ...
  leaderboard: {
    currentSnapshotData: [
      ...
      { rank: 14, name: 'David Huseby', activities: '', points: 0 },
      { rank: 15, name: 'Derrick Lam', activities: '', points: 0 },
      { rank: 16, name: 'Diana Stern', activities: '', points: 0 },
      { rank: 17, name: 'Diego Leal Togni', activities: '', points: 0 },
      { rank: 18, name: 'Dottie Wang', activities: '', points: 0 },
      { rank: 19, name: 'Erick Watson', activities: '', points: 0 },
      { rank: 20, name: 'Eshan Chordia', activities: '', points: 0 },
      { rank: 21, name: 'Evan Miyazono', activities: '', points: 0 },
      { rank: 22, name: 'Francesca Cohen', activities: '', points: 0 },
      { rank: 23, name: 'Holke Brammer', activities: '', points: 0 },
      { rank: 24, name: 'Ian Brunner', activities: '', points: 0 },
      { rank: 25, name: 'Jeff De Gregorio', activities: '', points: 0 },
      { rank: 26, name: 'Jennifer Denini', activities: '', points: 0 },
      { rank: 27, name: 'Jonathan Victor', activities: '', points: 0 },
      { rank: 28, name: 'Juan Benet', activities: '', points: 0 },
      { rank: 29, name: 'Julio Garcia', activities: '', points: 0 },
      { rank: 30, name: 'Justin Melillo', activities: '', points: 0 },
      { rank: 31, name: 'Karla Tang', activities: '', points: 0 },
      { rank: 32, name: 'Kevin Houng', activities: '', points: 0 },
      { rank: 33, name: 'Laura Brewer', activities: '', points: 0 },
      { rank: 34, name: 'Lynnette Nolan', activities: '', points: 0 },
      { rank: 35, name: 'Matthew Koch', activities: '', points: 0 },
      { rank: 36, name: 'Michael Stachiw', activities: '', points: 0 },
      { rank: 37, name: 'Michelle Lee', activities: '', points: 0 },
      { rank: 38, name: 'Molly Mackinlay', activities: '', points: 0 },
