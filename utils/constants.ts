...
export const PROJECT_ANALYTICS_EVENTS = {
  ...
  PROJECT_DETAIL_CONTRIBUTORS_MODAL_SEARCH_CHANGED: 'project-detail-contributors-modal-search-changed',
...
export const EVENTS_ANALYTICS = {
  ...
  EVENTS_PAGE_CONTRIBUTOR_LIST_SEARCH_CHANGED: 'events-page-contributor-list-search-changed',
...
export const DEMO_DAY_METADATA: Record<string, { title: string; description: string; imageUrl: string }> = {
  ...
  ['partner26-1']: {
    ...
    description:
      'An invite-only virtual event for accredited investors, featuring early-stage founders from Crecimiento and Founder School pitching AI, blockchain, and DeFi startups.',
    imageUrl: 'https://plabs-assets.s3.us-west-1.amazonaws.com/images/Social_thumbnail_PL_DD_Network_Partner_1.2.png',
  },
};
...
export const DEMO_DAY_ANALYTICS = {
  ...
  ON_LANDING_INVESTOR_PROFILE_LINK_CLICKED: 'demo-day-landing-investor-profile-link-clicked',
  ...
  ON_COMPLETED_VIEW_PAGE_OPENED: 'demo-day-completed-view-page-opened',
...
export const AI_APPS_ANALYTICS = {
  ...
  CREATOR_FILTER_SEARCHED: 'ai_apps_creator_filter_searched',
  SORT_CHANGED: 'ai_apps_sort_changed',
  FILTERS_CLEARED: 'ai_apps_filters_cleared',
  FILTERS_APPLIED: 'ai_apps_filters_applied',
  FILTERS_PANEL_DISMISSED: 'ai_apps_filters_panel_dismissed',
